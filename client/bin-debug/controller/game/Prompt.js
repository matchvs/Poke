        ...
        var Prompt = (function () {
            ...
            Prompt.prototype.GetPrompt = function (mylist, tableList, enemycount, teamcount, nextIsteam, lastIsTeam) {
                if (tableList == null) {
                    ...
                    if (cld != null && mylist.List.length - cld.List.length > 2 && lastIsTeam) {
                        ...
                        else if (cld.Type == controller.game.Types.Types_Bomb) {
                            return null;
                        }
                    }
                    return cld;
            ...
            Prompt.prototype.getbest = function (mylist, enemycount, teamcount, nextIsenemy) {
                ...
                var frontTypeList = [
                    ...
                    game.Types.Types_ThreeN_Double,
                    game.Types.Types_ThreeN,
                    game.Types.Types_DoubleN,
                    game.Types.Types_List,
                    game.Types.Types_Three_Signal,
                    game.Types.Types_Three_Double,
                    game.Types.Types_Three,
                    game.Types.Types_Double,
                    game.Types.Types_Signal,
                    //Types.Types_Four_Signal,
                    //Types.Types_Four_Double,
                    game.Types.Types_Bomb
                ];
                if (nextIsenemy) {
                    if (enemycount == 1) {
                        frontTypeList = [
