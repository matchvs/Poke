...
module scene {
    export class ChatMsgProxy {
        ...
        private init_1(txt:string):void
        {
            ...
            egret.Tween.get(this._chat_1).to({},ChatMsgProxy.flyTime).call(function():void {
                this._chat_1.visible=false;
            },this)
        }
        ...
        private init_2(txt:string):void
        {
            ...
            egret.Tween.get(this._chat_2).to({},ChatMsgProxy.flyTime).call(function():void
            {
                this._chat_2.visible=false;
            },this)
        }
        ...
        private init_3(txt:string):void
        {
            ...
            egret.Tween.get(this._chat_3).to({},ChatMsgProxy.flyTime).call(function():void
            {
                this._chat_3.visible=false;
            },this)
        }
        ...
        private initface_1(txt:string):void
        {
            ...
            egret.Tween.get(this._face_1).to({},ChatMsgProxy.flyTime).call(function():void {
                this._face_1.visible=false;
                this._face_1.removeChildren();
            },this)
        }
        ...
        private initface_2(txt:string):void
        {
            ...
            egret.Tween.get(this._face_2).to({},ChatMsgProxy.flyTime).call(function():void {
                this._face_2.visible=false;
                this._face_2.removeChildren();
            },this)
        }
        ...
        private initface_3(txt:string):void
        {
            ...
            egret.Tween.get(this._face_3).to({},ChatMsgProxy.flyTime).call(function():void {
                this._face_3.visible=false;
                this._face_3.removeChildren();
            },this)
        }
