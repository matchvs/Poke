module controller.game {
    //提示类,智能提示
    export class Prompt {
        private _types:Types = new Types();
        ...
        public GetPrompt(mylist:CardListData, tableList:CardListData, enemycount:number, teamcount:number, nextIsteam:boolean,lastIsTeam:boolean):CardListData {
            ...
            else                //有桌面牌,按类型出牌
            {
                ...
                {
                    if(cld.Type==controller.game.Types.Types_Signal)
                    {
                    ...
                    else if(cld.Type==controller.game.Types.Types_Double)
                    {
                    ...
                    else if(cld.Type==controller.game.Types.Types_Bomb)//不用炸弹
                    {
                        return null;
                    }
                }
        ...
        private getbest(mylist:CardListData, enemycount:number, teamcount:number, nextIsenemy:boolean):CardListData {
            ...
            var frontTypeList:any = [
                Types.Types_ThreeN_Signal,
                Types.Types_ThreeN_Double,
                Types.Types_ThreeN,
                Types.Types_DoubleN,
                Types.Types_List,
                Types.Types_Three_Signal,
                Types.Types_Three_Double,
                Types.Types_Three,
                Types.Types_Double,
                Types.Types_Signal,
